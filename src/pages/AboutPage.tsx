      ...
      <div className="text-center mb-16">
        <CMSBlockEditor 
          ...
          renderContent={(title, content, imageUrl) => (
            <>
              {imageUrl && <img src={imageUrl} alt="About Header" className="w-full h-64 md:h-96 object-cover rounded-3xl mb-12 shadow-2xl" />}
          ...
          <CMSBlockEditor 
            ...
            renderContent={(title, content, imageUrl) => (
              <>
                ...
                {imageUrl && <img src={imageUrl} alt="Our History" className="w-full h-64 object-cover rounded-2xl mb-8 shadow-md" />}

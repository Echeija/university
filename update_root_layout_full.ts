...
const rootLayoutContent = `import { useState } from 'react';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <div className="hidden md:flex h-10 bg-emerald-900 text-white items-center justify-between px-8 text-xs font-medium">
        <div className="flex items-center gap-6">
          ...
          <span>📞 +234 (0) 800-SMART-GLOBAL</span>
        </div>
        <div className="flex gap-4">
          <span className="opacity-80">NBTE & NUC Accredited Institutional Portal</span>
          <span className="bg-purple-700 px-2 py-0.5 rounded">LMS LIVE</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-600 to-purple-700 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                S
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4 text-white">
              <div className="w-10 h-10 bg-gradient-to-br from-emerald-600 to-purple-700 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg">
                S
              </div>
              <div className="flex flex-col">
                <span className="font-extrabold text-lg leading-none">SMART GLOBAL</span>
                <span className="text-[10px] text-emerald-400 tracking-[0.15em] font-bold uppercase">College of Technology</span>
              </div>
            </div>
...
fs.writeFileSync('src/layouts/RootLayout.tsx', rootLayoutContent);
